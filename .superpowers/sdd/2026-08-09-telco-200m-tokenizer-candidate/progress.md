...
Whole-plan correction: the Colab quota-audit producer now binds the exact current tokenizer, corpus manifest/build identity, and plan into canonical whole-document evidence at the single `EVIDENCE_DIR/quota_audit.json` path consumed by preserved reuse. The CLI receives `--corpus-manifest` and publishes atomically; legacy no-manifest function calls retain their tolerance response. Exact cache-disabled suite: 727 passed, 14 skipped.
Whole-plan identity correction: mandatory canonical/CLI audits recompute every plan's production-format self-hash and reject stale quota/policy content or malformed declarations before output; legacy no-manifest tolerance calls remain compatible. Exact cache-disabled suite: 731 passed, 14 skipped.
